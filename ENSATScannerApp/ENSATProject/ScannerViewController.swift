...
class ScannerViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "showDetailSegue" {
            let nextViewController = segue.destinationViewController as! DetailofBoxViewController
            nextViewController.fileID = decodedURL
        }
    }
    ...
    func launchApp(decodedURL: String) {
        ...
        /* before jumpto next page, the decodedURL will be transmited to next page
        by method "prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?)". */
